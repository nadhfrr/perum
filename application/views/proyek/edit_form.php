...
<head>
	...
	<title> Edit Proyek - DeDiamondPark </title>
</head>
					...
					<div class="card-body">
						...
						<form action="<?php base_url("proyek/edit") ?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('pemilik_proyek') ? 'is-invalid' : '' ?>" type="text" name="pemilik_proyek" min="0" placeholder="pemilik_proyek" value="<?php echo $proyek->pemilik_proyek ?>" />
								<div class="invalid-feedback">
