...
<ul class="sidebar navbar-nav">
    ...
    <li class="nav-item <?php echo $this->uri->segment(2) == '' ? 'active': '' ?>">
        <a class="nav-link" href="<?php echo site_url('data_pengguna') ?>">
    ...
    <li class="nav-item dropdown <?php echo $this->uri->segment(2) == 'home' ? 'active': '' ?>">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item" href="<?php echo site_url('rincian_bahan') ?>">Rincian Bahan</a>
            <a class="dropdown-item" href="<?php echo site_url('rincian_upah') ?>">Rincian Upah</a>
        </div>
    </li>
